"""
Generator for v2.6 Humanities + Soft Skills Dataset
...
class HumanitiesSoftSkillsGenerator:
    """Generate humanities soft skills examples (analogies, slang, friendly)"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate v2.6 Humanities + Soft Skills dataset")
    parser.add_argument(
        "--topics",
        default="topics/v2.7_humanities_softskills_topics.json",
    ...
    generator = HumanitiesSoftSkillsGenerator(
