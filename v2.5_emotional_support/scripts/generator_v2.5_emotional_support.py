"""
Generator for v2.6 Emotional Support Dataset
...
class EmotionalSupportGenerator:
    """Generate emotional support examples (analogies, slang, friendly)"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate v2.6 Emotional Support dataset")
    parser.add_argument(
        "--topics",
        default="topics/v2.5_emotional_support_topics.json",
    ...
    generator = EmotionalSupportGenerator(
